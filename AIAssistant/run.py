...
parser = argparse.ArgumentParser(description='Run Perplexia Assistant')
...
parser.add_argument('--Assistant', action='store_true',
                    help='Run Assistant code instead of student code')
...
if __name__ == "__main__":
    demo = create_demo(week=args.week, mode_str=args.mode, use_solution=args.Assistant)
    demo.launch()