...
def create_demo(week: int = 1, mode_str: str = "part1", use_solution: bool = False):
    ...
    Args:
        ...
        use_solution: If True, use Assistant implementation; if False, use student code
        
    Returns:
        gr.ChatInterface: Configured Gradio chat interface
    """
    # Determine code type label
    code_type = "Assistant" if use_solution else "Student"
    
    # Week 1 implementation
    if week == 1:
        # Import the appropriate factory based on use_solution flag
        if use_solution:
            from perplexia_ai.Assistant.week1.factory import Week1Mode, create_chat_implementation as create_chat
        else:
    ...
    # Week 2 implementation
        ...
        # Import the appropriate factory based on use_solution flag
        if use_solution:
            from perplexia_ai.Assistant.week2.factory import Week2Mode, create_chat_implementation as create_chat
        else:
    ...
    # Week 3 implementation
        ...
        # Import the appropriate factory based on use_solution flag
        if use_solution:
            from perplexia_ai.Assistant.week3.factory import Week3Mode, create_chat_implementation as create_chat
        else:
