...
class ToolUsingAgentChat(ChatInterface):
    ...
    def initialize(self) -> None:
        ...
        # Create MCP client for bookmarking_server:
        self.mcp_client = MultiServerMCPClient({
            "bookmarking": {
                "command": "uv",
                "args": ["run", BOOKMARK_MCP_SERVER_PATH],
                "transport": "stdio",
            }
        })
    ...
    def _create_tools(self) -> List[Any]:
        ...
        def get_weather(location: Annotated[str, "The location to get weather for (city, country)"]) -> str:
            ...
            # Or alternatively, you could combine all the results into a single string or
            # use include_answer=True to get the answer directly from Tavily.
