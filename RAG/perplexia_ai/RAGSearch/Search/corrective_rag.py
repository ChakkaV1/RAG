...
This workflow routes between document knowledge and web search to answer
...
from perplexia_ai.RAGSearch.Search.prompts import (
...
# Document paths
BASE_DIR = "/Users/satyavaishnavichakka/problem_first_ai_fullcode/RAG DataSet"
FILE_PATHS = [
...
CHROMA_PERSIST_DIRECTORY = "/Users/satyavaishnavichakka/problem_first_ai_fullcode/chroma_db"
